...
function ensureDictionaryPickerStyles() {
  ...
  style.textContent = `
    ...
    .text-panel-tab {
      ...
      font-size: clamp(12.2px, 3.0vw, 17.5px);
    ...
    @media (max-width: 520px) {
      ...
      .text-panel-tab { min-height: 37px; height: 37px; }
      .text-swipe-frame { height: min(51vh, 500px) !important; min-height: 350px !important; border-radius: 27px !important; }
